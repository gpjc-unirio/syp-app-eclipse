...
function SelectionBehavior(eventBus, selection, canvas, elementRegistry) {
  ...
  eventBus.on('element.click', function(event) {
    ...
    //alert("Informações do Elemento - " + "Id: " + element.id + " | Type: " + element.type + " | Name: " + element.businessObject.name);

	// Armazenar o id do elemento em elemento html.
	$('.elementId').val(element.id);
	onChangeSelectedElement();

    //TADEU: Requisição AJAX para o Controller para exibir as Informações do Elemento
    //$.ajax({
    //    type: "GET",
